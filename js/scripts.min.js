...
$(function(){	
	...
	$('.header__slider').slick({
	  	infinite: true,
		fade: true,
		prevArrow: '<img class="slider-arrows slider-arrows__left" src="img/arrow-left.svg" alt="Стрелка влево">',
		nextArrow: '<img class="slider-arrows slider-arrows__right" src="img/arrow-right.svg" alt="Стрелка вправо">',
...
$('<div class="quantity-nav"><div class="quantity-button quantity-up"><img src="img/plus.svg" alt="Знак плюса"></div><div class="quantity-button quantity-down"><img src="img/minus.svg" alt="Знак минуса"></div></div>').insertAfter('.quantity input');
	...
	$('.quantity-button').click(function(){
		 summ = $('.nights').val() * $('.summ').data('night') + ($('.guests').val() - 1) * $('.summ').data('guests');		
		$('.summ').html('$'+ ' ' + summ);
	});
